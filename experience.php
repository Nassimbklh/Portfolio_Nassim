        ...
        <div class="container">
            ...
            <ul class="timeline">
                ...
                <li class="timeline-inverted">
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>Depuis Janvier 2022</h4>
                            <h4 class="subheading">NINJA KONCEPT</h4>
                        </div>
                        <div class="timeline-body">
                ...
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>Octobre 2021 - Février 2022</h4>
                            <h4 class="subheading">NINJA KONCEPT</h4>
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">Il s'agit d'un contrat civique. j'ai pour mission d'entraîner des adulte comme des enfants a ce nouveau sport qui est le Ninja.
                ...
                <li class="timeline-inverted">
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            ...
                            <h4 class="subheading">ASSOCIATION LEILA</h4>
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">Durant ce stage, j'avais pour mission de réaliser l'ensemble du site internet de l'association LEILA et durant cette période,
                                j'étais suivie par un développeur de chez l'ANR (Agence National de la Recherche)</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted">
